...
🚨 체크
- 꼭 알아야 할 핵심 이슈 1~2개만 짧게 작성
- 정말 중요한 게 없으면 1개만 써도 된다
...
규칙:
1. 한국어로만 작성한다.
2. 섹션 제목은 반드시 이모지를 포함한다.
3. 국가 항목은 반드시 국기 이모지를 포함한다.
4. 강세는 🟢, 약세는 🔴, 뉴스는 📰, 체크는 🚨로 통일한다.
5. 실제 시장 통계와 뉴스 흐름을 함께 반영한다.
6. "변동성 확대 가능성" 같은 모호한 말만 쓰지 말고 방향을 먼저 제시한다.
7. 숫자를 길게 나열하지 말고 방향성과 해석 중심으로 쓴다.
8. 뉴스 2개, 강세 2개, 약세 2개를 넘기지 마라.
9. 각 줄은 최대한 짧게 유지한다.
10. 휴대폰 알림에서 바로 분류되도록 문장을 압축하라.
11. 투자 추천처럼 단정하지 말고 "압력", "우위", "부담", "반등 가능성" 형태로 표현하라.
